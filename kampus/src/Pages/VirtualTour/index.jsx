...
function VirtualTour(){
  ...
  {userLogged ? (
    <>
      ...
      <img
        src={tourStep === 0? backImgEntrance: tourStep === 1? backImgUx: tourStep === 2? backImgWeb: tourStep === 3? backImgData: tourStep === 4? backImgKitchen: tourStep === 5? backImgLounge: backImgEntrance}id="background-img"></img>
      <button onClick={tourStep === 5 ? navigatePortal : advanceTour} id="tour-button"> Next</button>
      <Modal
        classNames={{
          size: "4xl",
          body: "py-6",
