        ...
        <div>
          {tourStepContent.slice(0, tourStep + 1).map((stepContent, index) =>
            index === tourStep ? (
              <h1
                key={index}
                className="p-5 font-semibold text-xl bg-Color2 rounded-3xl"
              >
                <Typewriter
                  words={stepContent}
                  loop={1}
          ...
          <img
            ...
            id="background-img"
            style={{ width: "40vw", height: "auto", position: "fixed" }}
            className="  medium:mt-[28vh] small:mt-[30vh] main:"
            alt={`Step ${tourStep + 1}`}
          />
          <Button
            variant="solid"
